<script>
  ...
  function Powerups() {
    ...
    isBoughtList = JSON.parse(
      localStorage.getItem("isBought") != null
        ? localStorage.getItem("isBought")
        : ""
    );
      ...
      <div class="upgradeTemplate">
        <div>
          <img
            ...
            src="PixelArtHand.png"
            alt=""
          />
          <h3 class="showOnHover upgradeDescription">
            Buy one cursor to get 0.1 clicks / second
          </h3>
        </div>
        ...
        <div class="plusMinus">
          <div class="plusClass">
            <img
              ...
              alt="Minus"
            />
            <h3 class="showOnHover plusMinusDescription">
              Sells 1 Cursor for 50%
            </h3>
          </div>
          <div class="plusClass">
            <img
            ...
            />
            <h3 class="showOnHover plusMinusDescription">
              Purchase 1 cursor for {cursorCost} cookies
            </h3>
          </div>
        </div>
      </div>
