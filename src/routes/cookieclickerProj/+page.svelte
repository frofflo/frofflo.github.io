<script>
  ...
  */
  ...
  function Powerups(){
    ...
    isBoughtListPowerup = JSON.parse(localStorage.getItem('isBoughtPowerup') != null ? localStorage.getItem('isBoughtPowerup') : "")
  ...
  onMount(()=>{
    ...
    grandpaMultiplier = parseFloat(localStorage.getItem('grandpaMultiplier')??1);
    wheatfarmMultiplier = parseFloat(localStorage.getItem('wheatfarmMultiplier')??1);
    sugarcanefarmMultiplier = parseFloat(localStorage.getItem('sugarcanefarmMultiplier')??1);
    cacaofarmMultiplier = parseFloat(localStorage.getItem('cacaofarmMultiplier')??1);
    milkyfarmMultiplier = parseFloat(localStorage.getItem('milkyfarmMultiplier')??1);
    sugarcanefarmMultiplier = parseFloat(localStorage.getItem('sugarcanefarmMultiplier')??1);
  ...
  function wipeData(){
    ...
    cacaofarmMultiplier = parseFloat(localStorage.getItem('cacaofarmMultiplier')??1)
    milkyfarmMultiplier = parseFloat(localStorage.getItem('milkyfarmMultiplier')??1)
    factoryMultiplier = parseFloat(localStorage.getItem('factoryMultiplier')??1)

    upgradeList = [upgrade1, upgrade2, upgrade3, upgrade4, upgrade5, upgrade6, upgrade7]
  ...
  function checkPrice(value){
    if(value >= 1000000000000) return `${Math.round(100*value/1000000000000)/100}T`;
    if(value >= 1000000000) return `${Math.round(100*value/1000000000)/100}B`;
    if(value >= 1000000) return `${Math.round(100*value/1000000)/100}M`;
  ...
  class powerupIcon{
    constructor(isActive, cost, name, description, value, isBoughtPowerup, picURL, multiplierValue, duration){
    ...
    buy(){
      if (cookies >= this.cost){
        ...
        localStorage.setItem('isBoughtPowerup', JSON.stringify(isBoughtListPowerup)); 
  ...
  class upgradeEnhancerIcon{
    constructor(isActive, cost, name, description, value, isBoughtUpgradeEnhancer, picURL){
      this.isActive=isActive
      this.cost=cost
      this.name=name
      this.description=description
  ...
  let upgrade5 = new multipleUpgrades("cacaofarm", 50000, 1.25, "Buy one cacaofarm to get 100 cookies / second", cacaofarms, 100, "cacao.png")
  let upgrade6 = new multipleUpgrades("milkyfarm", 125000, 1.1, "Buy one milkyfarm to get 250 cookies / second", milkyfarms, 250, "cow.png")
  let upgrade7 = new multipleUpgrades("factory", 1000000, 1.05, "Buy one Factory to get 1500 cookies / second", factories, 1500, "factory.png")

  // Powerups
  let powerup1 = new powerupIcon(false, 100, "Click Boost", "Gives You A 2x Click Multiplier", 2, false, "PixelArtHand.png")
  let powerup2 = new powerupIcon(false, 500, "Click Boost", "Gives You A 1.5x Click Multiplier", 1.5, false, "PixelArtHand.png")
  let powerup3 = new powerupIcon(false, 2500, "Click Boost", "Gives You A 2x Click Multiplier", 2, false, "PixelArtHand.png")
  let powerup4 = new powerupIcon(false, 5000, "Click Boost", "Gives You A 1.5x Click Multiplier", 1.5, false, "PixelArtHand.png")
  let powerup5 = new powerupIcon(false, 55000, "Click Boost", "Gives You A 1.5x Click Multiplier", 1.5, false, "PixelArtHand.png")
  let powerup6 = new powerupIcon(false, 100000, "Click Boost", "Gives You A 2x Click Multiplier", 2, false, "PixelArtHand.png")
  let powerup7 = new powerupIcon(false, 350000, "Click Boost", "Gives You A 1.5x Click Multiplier", 1.5, false, "PixelArtHand.png")
  let powerup8 = new powerupIcon(false, 1000000, "Click Boost", "Gives You A 2x Click Multiplier", 2, false, "PixelArtHand.png")
  let powerup9 = new powerupIcon(false, 200, "Cookies", "Gives you 2x cookies for 60 seconds", 1, false, "Cookieimg.png", 0.02, 60)
  let powerup10 = new powerupIcon(false, 2000, "Cookies", "Gives you 3x cookies for 30 seconds", 1, false, "Cookieimg.png", 0.03, 30)
  let powerup11 = new powerupIcon(false, 50000, "Cookies", "Gives you 3x cookies for 30 seconds", 1, false, "Cookieimg.png", 0.03, 30)
  let powerup12 = new powerupIcon(false, 100000, "Cookies", "Gives you 3x cookies for 60 seconds", 1, false, "Cookieimg.png", 0.03, 60)
  let powerup13 = new powerupIcon(false, 250000, "Cookies", "Gives you 2x cookies for 30 seconds", 1, false, "Cookieimg.png", 0.02, 30)
  ...
  let upgradeEnhancer3 = new upgradeEnhancerIcon(false, 4500, "Cursors", "Gives You 2x Cursor Profits", 2, false, "PixelArtHand.png")
  ...
  let upgradeEnhancer6 = new upgradeEnhancerIcon(false, 800000, "Cursors", "Gives You 5x Cursor Profits", 5, false, "PixelArtHand.png")

  let upgradeEnhancer7 = new upgradeEnhancerIcon(false, 2000, "Grandpas", "Gives You 3x Grandpa Profits", 3, false, "grandpa.png")
  let upgradeEnhancer8 = new upgradeEnhancerIcon(false, 5500, "Grandpas", "Gives You 3x Grandpa Profits", 3, false, "grandpa.png")
  let upgradeEnhancer9 = new upgradeEnhancerIcon(false, 10000, "Grandpas", "Gives You 3x Grandpa Profits", 3, false, "grandpa.png")
  let upgradeEnhancer10 = new upgradeEnhancerIcon(false, 26000, "Grandpas", "Gives You 5x Grandpa Profits", 5, false, "grandpa.png")
  let upgradeEnhancer11 = new upgradeEnhancerIcon(false, 52000, "Grandpas", "Gives You 5x Grandpa Profits", 5, false, "grandpa.png")

  let upgradeEnhancer12 = new upgradeEnhancerIcon(false, 5000, "Wheat", "Gives You 2.5x Profits",2.5, false, "wheat.png")
  let upgradeEnhancer13 = new upgradeEnhancerIcon(false, 27000, "Wheat", "Gives You 2.5x Profits", 2.5, false, "wheat.png")
  let upgradeEnhancer14 = new upgradeEnhancerIcon(false, 54000, "Wheat", "Gives You 4x Profits", 4, false, "wheat.png")
  let upgradeEnhancer15 = new upgradeEnhancerIcon(false, 110000, "Wheat", "Gives You 4x Profits", 4, false, "wheat.png")
  let upgradeEnhancer16 = new upgradeEnhancerIcon(false, 200000, "Wheat", "Gives You 2.5x Profits", 2.5, false, "wheat.png")

  let upgradeEnhancer17 = new upgradeEnhancerIcon(false, 50000, "Sugar", "Gives You 3x Sugarcane Profits", 3, false, "sugarcane.png")
  let upgradeEnhancer18 = new upgradeEnhancerIcon(false, 275000, "Sugar", "Gives You 2x Sugarcane Profits", 2, false, "sugarcane.png")
  let upgradeEnhancer19 = new upgradeEnhancerIcon(false, 550000, "Sugar", "Gives You 2x Sugarcane Profits", 2, false, "sugarcane.png")
  let upgradeEnhancer20 = new upgradeEnhancerIcon(false, 2200000, "Sugar", "Gives You 5x Sugarcane Profits", 5, false, "sugarcane.png")

  let upgradeEnhancer21 = new upgradeEnhancerIcon(false, 150000, "Cacao", "Gives You 4x Cacaofarm Profits", 4, false, "cacao.png")
  let upgradeEnhancer22 = new upgradeEnhancerIcon(false, 300000, "Cacao", "Gives You 4x Cacaofarm Profits", 4, false, "cacao.png")
  let upgradeEnhancer23 = new upgradeEnhancerIcon(false, 700000, "Cacao", "Gives You 3x Cacaofarm Profits", 3, false, "cacao.png")
  let upgradeEnhancer24 = new upgradeEnhancerIcon(false, 2500000, "Cacao", "Gives You 4x Cacaofarm Profits", 4, false, "cacao.png")
  let upgradeEnhancer25 = new upgradeEnhancerIcon(false, 5000000, "Cacao", "Gives You 3x Cacaofarm Profits", 3, false, "cacao.png")


  let upgradeEnhancer26 = new upgradeEnhancerIcon(false, 250000, "Milk", "Gives You 3x Milkyfarm Profits",3 , false, "cow.png")
  let upgradeEnhancer27 = new upgradeEnhancerIcon(false, 500000, "Milk", "Gives You 5x Milkyfarm Profits", 5, false, "cow.png")
  let upgradeEnhancer28 = new upgradeEnhancerIcon(false, 1500000, "Milk", "Gives You 3x Milkyfarm Profits", 3, false, "cow.png")
  let upgradeEnhancer29 = new upgradeEnhancerIcon(false, 2750000, "Milk", "Gives You 3x Milkyfarm Profits", 3, false, "cow.png")
  let upgradeEnhancer30 = new upgradeEnhancerIcon(false, 5500000, "Milk", "Gives You 5x Milkyfarm Profits", 5, false, "cow.png")


  let upgradeEnhancer31 = new upgradeEnhancerIcon(false, 2000000, "Factories", "Gives You 3x Factory Profits", 3, false, "factory.png")
  let upgradeEnhancer32 = new upgradeEnhancerIcon(false, 10000000, "Factories", "Gives You 5x Factory Profits", 5, false, "factory.png")
  let upgradeEnhancer33 = new upgradeEnhancerIcon(false, 25000000, "Factories", "Gives You 10x Factory Profits", 10, false, "factory.png")
  ...
  let powerupList = [
    powerup1, powerup2, powerup3, powerup4, powerup5, powerup6, powerup7, powerup8, powerup9, powerup10, powerup11, powerup12, powerup13
  ]
  let upgradeEnhancerList = [
    upgradeEnhancer1, upgradeEnhancer2, upgradeEnhancer3, upgradeEnhancer4, upgradeEnhancer5, upgradeEnhancer6, upgradeEnhancer7, upgradeEnhancer8, upgradeEnhancer9, upgradeEnhancer10, upgradeEnhancer11, upgradeEnhancer12, upgradeEnhancer13, upgradeEnhancer14, upgradeEnhancer15, upgradeEnhancer16, upgradeEnhancer17, upgradeEnhancer18, upgradeEnhancer19, upgradeEnhancer20, upgradeEnhancer21, upgradeEnhancer22, upgradeEnhancer23, upgradeEnhancer24, upgradeEnhancer25, upgradeEnhancer26, upgradeEnhancer27, upgradeEnhancer28, upgradeEnhancer29, upgradeEnhancer30, upgradeEnhancer31, upgradeEnhancer32, upgradeEnhancer33
  ]
  
  setInterval(function(){
    autoClicks = timedMultiplier * ((cursors*cursorMultiplier)+(grandpas*grandpaMultiplier)+(wheatfarms*wheatfarmMultiplier)+(sugarcanefarms*sugarcanefarmMultiplier)+(cacaofarms*cacaofarmMultiplier)+(milkyfarms*milkyfarmMultiplier)+(factories*factoryMultiplier));
    cookiesPerSecond = autoClicks*100
    cookies += autoClicks*2.5

    upgradeEnhancerList.forEach((upgradeEnhance)=>{
      upgradeEnhance.isActive = cookies*2 >= upgradeEnhance.cost && ! upgradeEnhance.isBoughtUpgradeEnhancer
      upgradeEnhancerList = upgradeEnhancerList
    })

    powerupList.forEach(powerup=>{
      powerup.isActive = cookies*2 >= powerup.cost && ! powerup.isBoughtPowerup
      powerupList = powerupList;
    })
...
<div class="background">
    ...
    <div class="cookiebackground">
      ...
      <div class="cookieDisplayDiv"><h2 class="cookieDisplay">Cookies:{checkPrice(Math.ceil(cookies))}</h2></div>
    ...
    <div class="upgradePanel" class:hidden={activeStoreTab!="upgradesTab"}>
      ...
      <div class="upgradesFolder">
        ...
        <div class="upgradeTemplate">
            ...
            <div class="upgradeCostClass"><h5>{checkPrice(upgrade.upgradeCost)}</h5></div>
            <div class="plusMinus">
              ...
              <h3 class="showOnHover plusDescription">Purchase 1 {upgrade.name} for {checkPrice(upgrade.upgradeCost)} cookies</h3>
      ...
      <div class="upgrade-Enhancerfolder">
        {#each upgradeEnhancerList as upgradeEnhancer}
          <div class:hidden={!upgradeEnhancer.isActive}>
            ...
            <img src={upgradeEnhancer.picURL} alt="upgradeEnhancer" class="powerupicon" on:click={()=>{upgradeEnhancer.buy()}} on:keypress={()=>{upgradeEnhancer.buy()}}>
      ...
      <div class="Powerupsfolder">
        {#each powerupList as powerup}
          <div class:hidden={!powerup.isActive}>
            <p>{powerup.name}</p>
            <img src={powerup.picURL} alt="powerup" class="powerupicon" on:click={()=>{powerup.buy()}} on:keypress={()=>{powerup.buy()}}>
            <p>{powerup.cost}</p>
